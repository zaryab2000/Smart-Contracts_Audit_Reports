...
contract OneSeed is Context, IERC20, Ownable {
    ...
    mapping(address => Stake) private _stakeholders; // STAKING MAPPINGS START FROM HERE
    ...
    uint256 public _rewardsPerCall = 50;
    ...
    function getMyStakeReward(uint256 index) public view returns (address, uint256, uint256, uint256, uint256){
    ...
    function getMyPartnerReward(uint256 index) public view returns (address, address, uint256, uint256, uint256){
    ...
    function isAutoCompound() public view returns (bool){
        return isStaking(_msgSender()) && _stakeholders[_msgSender()].autoCompoundOn;
    }

    function toggleAutoCompound() public OnlyActiveStaker {
    ...
    function getGlobalStakingAmount() public view returns (uint256){
    ...
    function setRewardsPerCall(uint256 n) public restrictedOwner {
        require(n > 0);
        _rewardsPerCall = n;
    }

    function setGlobalMaxStakingAmount(uint256 amount) public restrictedOwner {
