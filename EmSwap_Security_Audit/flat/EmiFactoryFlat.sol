...
contract Emiswap is ERC20, ReentrancyGuard, Ownable {
    ...
    // mapping(address => SwapVolumes) public volumes;
    // mapping(address => VirtualBalance.Data) public virtualBalancesForAddition;
    // mapping(address => VirtualBalance.Data) public virtualBalancesForRemoval;
...
contract EmiFactory is Ownable {
    ...
    mapping(address => mapping(address => Emiswap)) public pools;
