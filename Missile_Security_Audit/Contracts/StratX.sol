...
contract StratX is Ownable, ReentrancyGuard, Pausable {
    ...
    bool public isMSIComp; // this vault is purely for staking. eg. WBNB-MSI staking vault.
    ...
    address public MSIFarmAddress;
    address public MSIAddress;
    ...
    address[] public earnedToMSIPath;
    ...
    constructor(
        ...
        MSIFarmAddress = _MSIFarmAddress;
        MSIAddress = _MSIAddress;

        isCAKEStaking = _isCAKEStaking;
        isMSIComp = _isMSIComp;
        ...
        if (isMSIComp) {
            ...
            earnedToMSIPath = [earnedAddress, wbnbAddress, MSIAddress];
            if (wbnbAddress == earnedAddress) {
                earnedToMSIPath = [wbnbAddress, MSIAddress];
            }
        ...
        transferOwnership(MSIFarmAddress);
    }
        ...
        returns (uint256)
    {
        ...
        IERC20(wantAddress).safeTransfer(MSIFarmAddress, _wantAmt);
