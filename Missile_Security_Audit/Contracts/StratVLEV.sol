...
contract StratVLEV is Ownable, ReentrancyGuard, Pausable {
    ...
    constructor(
        ...
        earnedToMSIPath = [venusAddress, wbnbAddress, MSIAddress];
    ...
    function buyBack(uint256 _earnedAmt) internal returns (uint256) {
        ...
        // Burn MSI tokens
        uint256 burnAmt = IERC20(MSIAddress).balanceOf(address(this));
        IERC20(MSIAddress).safeTransfer(buyBackAddress, burnAmt);
