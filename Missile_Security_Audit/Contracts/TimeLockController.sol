...
/**
 * @dev MSIFarm functions that do not require less than the min timelock
 */
interface IMSIFarm {
    function add(
        uint256 _allocPoint,
...
contract TimelockController is AccessControl {
    ...
    function executeSet(
        ...
        _beforeCall(predecessor);
        IMSIFarm(_MSIfarmAddress).set(_pid, _allocPoint, _withUpdate);
        _afterCall(id);
    }
    ...
    function add(
        ...
        IMSIFarm(_MSIfarmAddress).add(0, _want, _withUpdate, _strat); // allocPoint = 0. Schedule set (timelocked) to increase allocPoint.
    }
